...
const init = [
  ...
  { id: 2, screenName: 'Abd El-Rahman Mostafa', lastSeen: 'recently', avatar: 'AM' },
  { id: 3, screenName: 'Abdallah Salah', lastSeen: 'Nov 23 at 15:11', avatar: 'AS' },
  {
    id: 4,
  ...
  { id: 6, screenName: 'Abdulrahman Samy', lastSeen: '1 minute ago', avatar: 'AS' },
  {
    id: 7,
  ...
  { id: 9, screenName: 'Adham Hussin', lastSeen: 'Nov 1 at 15:42', avatar: 'AH' },
  {
    id: 10,
    screenName: 'Abdulrahman Abdul Aaty',
    lastSeen: 'Nov 25 at 17:08',
  ...
  { id: 11, screenName: 'Abdulrahman Samy', lastSeen: '1 minute ago', avatar: 'AS' },
  {
    id: 12,
    screenName: 'Adham Abd Elazeem',
    lastSeen: 'yesterday at 23:54',
  ...
  { id: 14, screenName: 'Adham Hussin', lastSeen: 'Nov 1 at 15:42', avatar: 'AH' },
  {
    id: 15,
    screenName: 'Abdulrahman Abdul Aaty',
    lastSeen: 'Nov 25 at 17:08',
  ...
  { id: 16, screenName: 'Abdulrahman Samy', lastSeen: '1 minute ago', avatar: 'AS' },
  {
    id: 17,
    screenName: 'Adham Abd Elazeem',
    lastSeen: 'yesterday at 23:54',
  ...
  { id: 19, screenName: 'Adham Hussin', lastSeen: 'Nov 1 at 15:42', avatar: 'AH' },
];
...
const AddUsersList = ({ addedMembers, setAddedMembers }) => {
  ...
  useEffect(() => {
    ...
    const fetchContacts = async () => {
      try {
        const response = await fetch(`${apiUrl}/v1/privacy/settings/get-contacts`, {
          method: 'GET',
          headers: {
