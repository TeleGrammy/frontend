...
const WelcomeMessage = ({ signIn = true }) => {
  ...
  return (
    <div
      className="flex w-full flex-col items-center justify-center rounded-none bg-sky-950 p-6 text-white md:w-1/2 md:rounded-lg md:p-8"
    ...
    >
      ...
      <p className="mt-4" data-testid="account-message">
      ...
      <button
        ...
        data-testid="auth-button" // Added data-testid for the button
      >
